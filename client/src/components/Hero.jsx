    ...
    return (
        <section className="h-full flex relative bg-hero-pattern bg-cover min-[390px]:" id="Hero">
            ...
            <div className="absolute top-36 right-0 flex flex-col text-left justify-center max-w-[700px] gap-6 px-14">
                ...
                <Link className="px-14 py-4 bg-[#007654] transition hover:bg-[#105642] text-[#fefefe] rounded-lg w-fit text-center items-center text-2xl overflow-hidden animation" to={"/register"}></Link>
            </div>
        </section>
    )
}
