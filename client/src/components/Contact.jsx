...
const Contact = () => {
  return (
    <section className="flex-col px-14 py-44 pb-10" id="Contact">
      ...
      <form action="#" method="POST" className="mx-auto mt-16 mb-16 max-w-xl p-14 shadow-2xl rounded-2xl shadow-[#007654] hover:shadow-[#007654] bg-[#398650] sm:mt-20 flex-col space-y-10">
