    ...
    return (
        <section className="flex flex-col space-y-10 px-14 pt-14 pb-40" id="About">
            ...
            <div className="flex gap-12 items-center ">
                ...
                <img src={about1} className="max-h-80 transition  shadow-lg shadow-[#007654] rounded-3xl"/>

            </div>

            <div className="flex gap-12 items-center ">
                <img src={about2} className="max-h-80 transition  shadow-lg shadow-[#007654] rounded-3xl"/>
                <div className="space-y-4">
