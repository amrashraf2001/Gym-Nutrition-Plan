        ...
        <section className=" flex flex-col space-y-10 px-14 pt-14 pb-40 " id="About">
            ...
            <div className="flex gap-12 items-center md:flex-row-reverse flex-col ">
                <motion.img
                    ...
                    initial={{ opacity: 0, x: 200 }}
                    transition={{ duration: 0.5 }}
                    src={about1} className="max-h-80 shadow-lg shadow-[#007654] rounded-3xl max-w-[20rem]" />
                <motion.div
                    whileInView={{ opacity: 1, x: 0 }}
                    initial={{ opacity: 0, x: -200 }}
                    transition={{ duration: 0.5 }}
            ...
            <div className="flex gap-12 items-center flex-col md:flex-row  ">
                <motion.img
                    whileInView={{ opacity: 1, x: 0 }}
                    initial={{ opacity: 0, x: -200 }}
                    transition={{ duration: 0.5 }} src={about2} className="max-h-80 shadow-lg shadow-[#007654] rounded-3xl max-w-[20rem]" />
                <motion.div
                    whileInView={{ opacity: 1, x: 0 }}
                    initial={{ opacity: 0, x: 200 }}
                    transition={{ duration: 0.5 }}
