            ...
            {success ? (
                ...
                <section className="flex flex-col items-center justify-center h-full">
                    ...
                    <div className="bg-[#fefefe] rounded-lg shadow-lg shadow-[#007654] space-y-6 px-8 py-6 max-w-md w-3/4">
                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col space-y-3 items-left">
                            ...
                            <div className=" relative space-y-1">
                                ...
                                <p id="pwdnote" className={pwdFocus && pwd && !validPwd ? "visible text-xs items-start flex gap-1 bg-neutral-800 text-white rounded-md p-1" : "hidden"}>
                                    <FaInfoCircle />
                            ...
                            <div className=" relative space-y-1">
                                ...
                                <input
                                    ...
                                    className="shadow-sm mb-2 rounded-md w-full px-3 py-2 border border-gray-300 focus:outline-none focus:ring-[#007654] focus:border-[#007654] focus:shadow-sm focus:shadow-[#52c0a7]" placeholder="Confirm password" required />
                            ...
                            <button type="submit" disabled={!validEmail || !validMatch || !validName || !validPwd ? true : false} className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white hover:bg-[#105642] bg-[#007654] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#007654] transition-all cursor-pointer disabled:bg-opacity-50">Sign Up</button>
