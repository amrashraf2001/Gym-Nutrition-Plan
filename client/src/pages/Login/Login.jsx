    ...
    return (
        ...
        <div className="bg-white rounded-lg shadow-lg shadow-[#007654] space-y-6 px-8 py-6 max-w-md w-3/4">
            ...
            <div
                className={ errMsg ? "bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative text-center": "hidden" }
                role="alert"
                >
                ...
                <div className=" relative space-y-1 select-none">
                    ...
                    onClick={onEyeClick}
                    htmlFor="password"
                    className={pwd? "absolute top-3 right-2 z-10 cursor-pointer" : "hidden"}
                    >
                    <TbEyeClosed
                        className={showPwd ? "visible size-6 mt-1 mr-1" : "hidden"}
                    />
                    <VscEye
                        className={showPwd? "hidden" : "visible size-7 " 
                        }
                    />
                    </span>
                    <input
                ...
                <button
                    ...
                    className={(user && pwd? "" : "cursor-default" ) +" w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white hover:bg-[#105642] bg-[#007654] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#007654] transition-all cursor-pointer disabled:bg-opacity-50"}
                >
                    Log In
                </button>
